...
package flash.ui
{
	public final class Keyboard 
	{
		...
		{
			throw new Error('Keyboard: attempted call to an unimplemented function "capsLock"');
		}


		public static function get hasVirtualKeyboard () : Boolean
		{
			throw new Error('Keyboard: attempted call to an unimplemented function "hasVirtualKeyboard"');
		}


		public static function get numLock () : Boolean
		{
			throw new Error('Keyboard: attempted call to an unimplemented function "numLock"');
		}


		public static function get physicalKeyboardType () : String
		{
			throw new Error('Keyboard: attempted call to an unimplemented function "physicalKeyboardType"');
		}


		public static function isAccessible () : Boolean
		{
			throw new Error('Keyboard: attempted call to an unimplemented function "isAccessible"');
		}

		public function Keyboard ()
		{
			throw new Error('Keyboard: attempted call to an unimplemented constructor');
		}
