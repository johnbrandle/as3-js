...
$es4.$$package('sweetrush').Transcompiler = (function ()
{
	...
	$es4.$$private_property('_swcs', Transcompiler);
...
;
		...
		$es4.$$private_function('getBuiltinSWC', $$thisp, (function ($$$$platform)
		{
			...
			{
				return $es4.$$call(SwcUtil, $$this, $$thisp, 'parseSWCString', [builtinSWCString]);
			}
			...
			return $es4.$$set(Transcompiler, $$this, $$thisp, '_swcs', 'builtin', platform, $es4.$$call(SwcUtil, $$this, $$thisp, 'parseSWCString', [$es4.$$get(result, $$this, $$thisp, 'swc')]), '=');
		}));
		...
		$es4.$$private_function('getPlayerGlobalSWC', $$thisp, (function ($$$$translationMode, $$$$platform)
		{
			...
			if ($es4.$$get(Transcompiler, $$this, $$thisp, '_swcs', 'builtin', platform + '_' + translationMode))
			{
				return $es4.$$get(Transcompiler, $$this, $$thisp, '_swcs', 'builtin', platform + '_' + translationMode, 1);
			}
			...
			{
				return $es4.$$call(SwcUtil, $$this, $$thisp, 'parseSWCString', [playerGlobalSWCString]);
			}
			...
			$es4.$$set(Transcompiler, $$this, $$thisp, '_swcs', 'builtin', platform + '_' + translationMode, [playerGlobalJS], '=');
			return $es4.$$set(Transcompiler, $$this, $$thisp, '_swcs', 'builtin', platform + '_' + translationMode, 1, $es4.$$call(SwcUtil, $$this, $$thisp, 'parseSWCString', [$es4.$$get(result, $$this, $$thisp, 'swc')]), '=');
		}));
		...
		$es4.$$private_function('getPlayerGlobalJS', $$thisp, (function ($$$$translationMode, $$$$platform)
		{
			...
			return $es4.$$get(Transcompiler, $$this, $$thisp, '_swcs', 'builtin', platform + '_' + translationMode, 0);
		}));
