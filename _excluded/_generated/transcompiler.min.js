...
window.document = {body:{style:{}}, createElement:function() { return {addEventListener:function() {}, setAttribute:function() {}, style:{}}}};
$es4.$$window = global;
...
$es4.$$package('flash.utils').ByteArray = (function ()
{
	...
	function ByteArray()
	{
		...
		$es4.$$public_function('$__properties', $$thisp, (function ($$$$object)
		{
			...
			if ($es4.$$get($$thisp, $$this, $$thisp, '$_properties') === undefined)
			{
				var buffer = $es4.$$primitive(new ($es4.$$get(window, $$this, $$thisp, 'Buffer'))($es4.$$get(ByteArray, $$this, $$thisp, 'BYTES_GROW_SIZE')));
		...
		$es4.$$public_function('writeBytes', $$thisp, (function ($$$$readFrom, $$$$offset, $$$$length)
		{
			...
			if (newBytePosition > $es4.$$get($$thisp, $$this, $$thisp, '$_properties', 'ByteArrayScope', '$_byteLength'))
			{
				if (newBytePosition > $es4.$$get($$thisp, $$this, $$thisp, '$_properties', 'ByteArrayScope', '$_buffer', 'length'))
				{
					buffer = $es4.$$call(window, $$this, $$thisp, 'Buffer', 'concat', [[$es4.$$get($$thisp, $$this, $$thisp, '$_properties', 'ByteArrayScope', '$_buffer'), $es4.$$primitive(new ($es4.$$get(window, $$this, $$thisp, 'Buffer'))(newBytePosition + ($es4.$$set($$thisp, $$this, $$thisp, '$_properties', 'ByteArrayScope', '$_growSize', $es4.$$get($$thisp, $$this, $$thisp, '$_properties', 'ByteArrayScope', '$_growSize') * 2, '='))))]]);
				}
				$es4.$$set($$thisp, $$this, $$thisp, '$_properties', 'ByteArrayScope', '$_byteLength', newBytePosition, '=');
			}
		...
		}), (function ($$$$value)
		{
			...
			{
				buffer = $es4.$$call(window, $$this, $$thisp, 'Buffer', 'concat', [[$es4.$$get($$thisp, $$this, $$thisp, '$_properties', 'ByteArrayScope', '$_buffer'), $es4.$$primitive(new ($es4.$$get(window, $$this, $$thisp, 'Buffer'))(value + ($es4.$$set($$thisp, $$this, $$thisp, '$_properties', 'ByteArrayScope', '$_growSize', $es4.$$get($$thisp, $$this, $$thisp, '$_properties', 'ByteArrayScope', '$_growSize') * 2, '='))))]]);
				$es4.$$set($$thisp, $$this, $$thisp, '$_properties', 'ByteArrayScope', '$_buffer', buffer, '=');
				$es4.$$set($$thisp, $$this, $$thisp, '$_properties', 'ByteArrayScope', '$_byteLength', value, '=');
			}
		}));
...
$es4.$$package('flash.utils').Dictionary = (function ()
{
	...
	function Dictionary()
	{
		...
		$es4.$$iinit($$thisp, (function ()
		{
			...
			$es4.$$set($$this, $$this, $$thisp, '$map', $es4.$$primitive(new ($es4.$$get(window, $$this, $$thisp, 'Map'))()), '=');
...
$es4.$$package('flash.utils').clearInterval = (function ()
{
	...
	function clearInterval($$$$id)
	{
		...
		$es4.$$call(window, $$this, $$thisp, 'clearInterval', [id]);
}
...
$es4.$$package('flash.utils').clearTimeout = (function ()
{
	...
	function clearTimeout($$$$id)
	{
		...
		$es4.$$call(window, $$this, $$thisp, 'clearTimeout', [id]);
}
...
$es4.$$package('flash.utils').getTimer = (function ()
{
	...
	function getTimer()
	{
		...
		return $es4.$$coerce($es4.$$call($es4.$$primitive(new (Date)()), $$this, $$thisp, 'getTime', $es4.$$EMPTY_ARRAY) - $es4.$$get(window, $$this, $$thisp, '$es4', '$$startTime'), int);
}
...
;
		...
		return $es4.$$coerce($es4.$$call(window, $$this, $$thisp, 'setInterval', [innerClosure, delay]), uint);
}
...
$es4.$$package('flash.utils').setTimeout = (function ()
{
	...
	function setTimeout($$$$closure, $$$$delay, $$$$rest)
	{
		...
		return $es4.$$coerce($es4.$$call(window, $$this, $$thisp, 'setTimeout', [function () 
{
	$es4.$$call(closure, $$this, $$thisp, 'apply', [this, rest]);
}
, delay]), uint);
...
$es4.$$package('sweetrush').Transcompiler = (function ()
{
	...
	function Transcompiler()
	{
		...
		$es4.$$public_function('compile', $$thisp, (function ($$$$params, $$$$platform)
		{
			...
			var pre = (platform != 'node') ? '//__ES4__\n\n(function() { var $window = this; var window = $window.parent || $window; var document = window.document; var $es4 = window.$es4 || (window.$es4 = {}); var _ = window._; var $ = window.$; var alert = window.alert; \n\n' : '';
		...
		$es4.$$private_function('getSrcFiles', $$thisp, (function ($$$$srcDir, $$$$srcFiles, $$$$excludeDirectories, $$$$platform)
		{
			...
			function insertIncludes($$$$filePath, $$$$fileContents, $$$$includes) 
			{
				...
				function doReplace($$$$match, $$$$offset, $$$$string) 
				{
					...
					$es4.$$set(includes, $$this, $$thisp, includePath, includePath, '=');
			...
			while (innerExpression = $es4.$$get(innerExpression, $$this, $$thisp, 'nextPropertyExpression'))
			{
				if ($es4.$$get(innerExpression, $$this, $$thisp, 'construct', 'constructor') == $es4.$$get(Construct, $$this, $$thisp, 'DotConstruct') || $es4.$$get(innerExpression, $$this, $$thisp, 'construct', 'constructor') == $es4.$$get(Construct, $$this, $$thisp, 'IdentifierConstruct'))
				{
					if (lastIdentifier && $es4.$$get(lastIdentifier, $$this, $$thisp, 'name') == 'this')
					{
						if ($es4.$$get($$thisp, $$this, $$thisp, '_treatThisAsDynamic'))
						{
							$es4.$$set(innerExpression, $$this, $$thisp, 'construct', 'identifier', $es4.$$call($$thisp, $$this, $$thisp, 'lookupIdentifier', ['window']), '=');
						}
						else
						{
...
;
		...
		if ($es4.$$get(packageConstruct, null, null, 'classConstruct'))
		{
			if ($es4.$$get(packageConstruct, null, null, 'classConstruct', 'UNIMPLEMENTEDToken'))
			{
				...
				js = ($es4.$$get(packageConstruct, null, null, 'nameConstruct')) ? '$es4.$$package(\'' + $es4.$$call(Construct, null, null, 'nameConstructToString', [$es4.$$get(packageConstruct, null, null, 'nameConstruct')]) + '\')' : 'window';
...
;
		...
		if ($es4.$$get(packageConstruct, null, null, 'classConstruct'))
		{
			if ($es4.$$get(packageConstruct, null, null, 'classConstruct', 'UNIMPLEMENTEDToken'))
			{
				...
				js = ($es4.$$get(packageConstruct, null, null, 'nameConstruct')) ? '$$package(\'' + $es4.$$call(Construct, null, null, 'nameConstructToString', [$es4.$$get(packageConstruct, null, null, 'nameConstruct')]) + '\')' : 'window';
				js += '.' + $es4.$$get(packageConstruct, null, null, 'classConstruct', 'identifierToken', 'data');
				js += ' = function () { throw new Error(\'Use of unimplemented class: ' + $es4.$$get(packageConstruct, null, null, 'classConstruct', 'identifierToken', 'data') + '\'); }';
				js += '\n';
				return js;
...
$es4.$$package('sweetrush.utils').Base64Util = (function ()
{
	...
	$es4.$$public_function('encodeString', Base64Util, (function ($$$$value)
	{
		...
		if (true)
		{
			if ($es4.$$get(window, null, null, 'btoa') !== undefined)
			{
				return $es4.$$coerce($es4.$$call(window, null, null, 'btoa', [value]), String);
			}
			return $es4.$$coerce($es4.$$call($es4.$$call(window, null, null, 'Buffer', 'from', [value]), null, null, 'toString', ['base64']), String);
		}
	}));
	...
	$es4.$$public_function('decodeString', Base64Util, (function ($$$$str)
	{
		...
		if (true)
		{
			if ($es4.$$get(window, null, null, 'atob') !== undefined)
			{
				return $es4.$$coerce($es4.$$call(window, null, null, 'atob', [str]), String);
			}
			return $es4.$$coerce($es4.$$call($es4.$$call(window, null, null, 'Buffer', 'from', [str, 'base64']), null, null, 'toString', $es4.$$EMPTY_ARRAY), String);
		}
	}));
