...
$es4.$$package('sweetrush').Transcompiler = (function ()
{
	...
	$es4.$$private_property('_builtinSWCString', Transcompiler, String);
	$es4.$$private_property('_builtinSWC', Transcompiler, Object);
	$es4.$$private_property('_playerGlobalSWCString', Transcompiler, String);
	$es4.$$private_property('_playerGlobalSWC', Transcompiler, Object);
	$es4.$$private_property('_playerGlobalJS', Transcompiler, String);
	...
	function Transcompiler()
	{
		...
		$es4.$$public_function('compileTranscompiler', $$thisp, (function ($$$$translationMode, $$$$platform)
		{
			...
			return $es4.$$call($$this, $$this, $$thisp, 'compile', [{srcDir:$es4.$$call(FileUtil, $$this, $$thisp, 'getBasePath', $es4.$$EMPTY_ARRAY), mainFile:"sweetrush/Transcompiler.as", compileConstants:{'CONFIG::air':'false', 'CONFIG::node':'true'}, includeBootstrap:true, includePlayerGlobal:true, expose:'transcompiler', translationMode:translationMode, excludeDirectories:['_excluded', 'node_modules']}, platform]);
		}));

		//method
		$es4.$$public_function('compile', $$thisp, (function ($$$$params, $$$$platform)
		{
			//set default parameter values
			...
			var includeBootstrap = $es4.$$coerce($es4.$$get(params, $$this, $$thisp, 'includeBootstrap'), Boolean);
			var includePlayerGlobal = $es4.$$coerce($es4.$$get(params, $$this, $$thisp, 'includePlayerGlobal'), Boolean);
			var expose = $es4.$$coerce($es4.$$get(params, $$this, $$thisp, 'expose') ? $es4.$$get(params, $$this, $$thisp, 'expose') : null, String);
...
;
		...
		$es4.$$private_function('getBuiltinSWC', $$thisp, (function ($$$$platform)
		{
			...
			if (builtinSWCString && $es4.$$get(Transcompiler, $$this, $$thisp, '_builtinSWCString') != builtinSWCString && $es4.$$call(SwcUtil, $$this, $$thisp, 'isValidSWCString', [builtinSWCString]))
			{
				$es4.$$set(Transcompiler, $$this, $$thisp, '_builtinSWC', $es4.$$call(SwcUtil, $$this, $$thisp, 'parseSWCString', [builtinSWCString]), '=');
				$es4.$$set(Transcompiler, $$this, $$thisp, '_builtinSWCString', builtinSWCString, '=');
			}
			if (!$es4.$$get(Transcompiler, $$this, $$thisp, '_builtinSWC'))
			{
				var srcDir = $es4.$$call(FileUtil, $$this, $$thisp, 'getExcludedPath', $es4.$$EMPTY_ARRAY) + '/builtin';
				var result = $es4.$$call($$this, $$this, $$thisp, 'compile', [{srcDir:srcDir, translationMode:1, special:true}, platform]);
				$es4.$$call(FileUtil, $$this, $$thisp, 'write', [builtinSWCFile, $es4.$$get(result, $$this, $$thisp, 'swc')]);
				$es4.$$set(Transcompiler, $$this, $$thisp, '_builtinSWC', $es4.$$call(SwcUtil, $$this, $$thisp, 'parseSWCString', [$es4.$$get(result, $$this, $$thisp, 'swc')]), '=');
				$es4.$$set(Transcompiler, $$this, $$thisp, '_builtinSWCString', $es4.$$get(result, $$this, $$thisp, 'swc'), '=');
			}
			return $es4.$$get(Transcompiler, $$this, $$thisp, '_builtinSWC');
		}));
		...
		$es4.$$private_function('getPlayerGlobalSWC', $$thisp, (function ($$$$translationMode, $$$$platform)
		{
			...
			if (playerGlobalSWCString && playerGlobalJS && $es4.$$get(Transcompiler, $$this, $$thisp, '_playerGlobalSWCString') != playerGlobalSWCString && $es4.$$call(SwcUtil, $$this, $$thisp, 'isValidSWCString', [playerGlobalSWCString]))
			{
				$es4.$$set(Transcompiler, $$this, $$thisp, '_playerGlobalSWC', $es4.$$call(SwcUtil, $$this, $$thisp, 'parseSWCString', [playerGlobalSWCString]), '=');
				$es4.$$set(Transcompiler, $$this, $$thisp, '_playerGlobalJS', playerGlobalJS, '=');
				$es4.$$set(Transcompiler, $$this, $$thisp, '_playerGlobalSWCString', playerGlobalSWCString, '=');
			}
			if (!$es4.$$get(Transcompiler, $$this, $$thisp, '_playerGlobalSWC'))
			{
				var srcDir = $es4.$$call(FileUtil, $$this, $$thisp, 'getExcludedPath', $es4.$$EMPTY_ARRAY) + '/playerglobal';
				var result = $es4.$$call($$this, $$this, $$thisp, 'compile', [{srcDir:srcDir, translationMode:translationMode, swcs:[$es4.$$call($$thisp, $$this, $$thisp, 'getBuiltinSWC', [platform])], special:true}, platform]);
				...
				$es4.$$set(Transcompiler, $$this, $$thisp, '_playerGlobalSWC', $es4.$$call(SwcUtil, $$this, $$thisp, 'parseSWCString', [$es4.$$get(result, $$this, $$thisp, 'swc')]), '=');
				$es4.$$set(Transcompiler, $$this, $$thisp, '_playerGlobalSWCString', $es4.$$get(result, $$this, $$thisp, 'swc'), '=');
				$es4.$$set(Transcompiler, $$this, $$thisp, '_playerGlobalJS', $es4.$$get(result, $$this, $$thisp, 'js'), '=');
			}
			return $es4.$$get(Transcompiler, $$this, $$thisp, '_playerGlobalSWC');
		}));
		...
		$es4.$$private_function('getPlayerGlobalJS', $$thisp, (function ($$$$translationMode, $$$$platform)
		{
			...
			return $es4.$$get(Transcompiler, $$this, $$thisp, '_playerGlobalJS');
		}));
...
$es4.$$package('sweetrush.utils').FileUtil = (function ()
{
	...
	$es4.$$public_function('getBasePath', FileUtil, (function ()
	{
		...
		if (true)
		{
			return $es4.$$call(FileUtil, null, null, 'path', 'join', [__dirname, '../../../', 'transcompiler']);
		}
		if (false)
		{
		}
	...
	$es4.$$public_function('getExcludedPath', FileUtil, (function ()
	{
		...
		if (true)
		{
			return $es4.$$call(FileUtil, null, null, 'path', 'join', [__dirname, '../../../', 'transcompiler', '_excluded']);
		}
		if (false)
		{
		}
